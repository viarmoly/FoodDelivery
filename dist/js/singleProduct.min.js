...
},{"./_fails":64,"./_iobject":77,"./_object-gops":104,"./_object-keys":107,"./_object-pie":108,"./_to-object":142}],98:[function(require,module,exports){
...
},{"./_object-keys":107,"./_object-pie":108,"./_to-iobject":140}],111:[function(require,module,exports){
...
exports.carouselOnload = carouselOnload;
...
function carouselOnload() {
  ...
  if (carouselId) {
    carouselId.innerHTML = "".concat(drawCarousel());
    carousel();
...
exports.sendAjaxRequest = sendAjaxRequest;
...
var _filtration = require("./filtration");
...
regeneratorRuntime.mark(function _callee() {
  var data, items, container, paginationContainer, saladRoot, soupRoot, hotmealsRoot, drinksRoot, ukrFoodRoot, itaFoodRoot, asiaFoodRoot, businessLunchRoot, productFilters, title;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          (0, _header2.headerLoad)();
          _context.prev = 2;
          _context.next = 5;
          return sendAjaxRequest('GET', './data/db.json');

        case 5:
          data = _context.sent;
          items = JSON.parse(data);
          PRODUCTS.push.apply(PRODUCTS, _toConsumableArray(items));
          container = document.createElement('div');
          container.classList.add('container-menu-item');
          container.setAttribute('id', 'container');
          paginationContainer = document.createElement('div');
          paginationContainer.setAttribute('id', 'pagination');
          saladRoot = document.getElementById('salads');
          soupRoot = document.getElementById('soups');
          hotmealsRoot = document.getElementById('hotmeals');
          drinksRoot = document.getElementById('drinks');
          ukrFoodRoot = document.getElementById('ukr-food');
          itaFoodRoot = document.getElementById('ita-food');
          asiaFoodRoot = document.getElementById('asia-food');
          businessLunchRoot = document.getElementById('business-lunch');
          productFilters = document.createElement('div');
          ...
          items.forEach(function (item) {
            if (soupRoot && item.type === "soup") {
              ...
              var soupSection = (0, _displayItems.displayItems)(item);
            ...
            if (saladRoot && item.type === "salad") {
              ...
              var saladSection = (0, _displayItems.displayItems)(item);
              productFilters.append(title);
            ...
            if (hotmealsRoot && item.type === "hotmeals") {
              ...
              var hotmealsSection = (0, _displayItems.displayItems)(item);
              container.append(hotmealsSection);
            }

            if (drinksRoot && item.cuisine === "drinks") {
              title.innerText = 'Напитки';
              var drinksSection = (0, _displayItems.displayItems)(item);
              productFilters.append(title);
            ...
            if (ukrFoodRoot && item.cuisine === "ukrainian") {
              ...
              var ukrFoodSection = (0, _displayItems.displayItems)(item);
              productFilters.append(title);
            ...
            if (itaFoodRoot && item.cuisine === "italian") {
              ...
              var itaFoodSection = (0, _displayItems.displayItems)(item);
              productFilters.append(title);
            ...
            if (asiaFoodRoot && item.cuisine === "asian") {
              ...
              var asiaFoodSection = (0, _displayItems.displayItems)(item);
              productFilters.append(title);
              container.append(asiaFoodSection);
            }

            if (businessLunchRoot && item.type === "business-lunch") {
              var businessLunchSection = (0, _displayItems.displayLunchItems)(item);
          ...
          (0, _filtration.drawFiltration)();
          (0, _sorting.drawSorting)();
...
},{"./displayItems":310,"./filtration":311,"./header":312,"./header.js":312,"./pagination":313,"./sorting":316,"./store.js":317,"@babel/polyfill":1}],310:[function(require,module,exports){
"use strict";
...
exports.displayLunchItems = displayLunchItems;
...
function addItem(ev) {
  ...
  _store.CART.add(id, 1);

  (0, _header.incrementHeaderData)();
}

function displayItems(item) {
  var itemName = item.name;
  var ingredientsCut = item.ingredients.join(", ");
  ...
  card.setAttribute('prod-type', "".concat(item.type));
  ...
  price.textContent = "".concat(item.price, " \u0433\u0440\u043D");
...
function displayLunchItems(item) {
  ...
  content.appendChild(title);
  var ingridientsCont = document.createElement('div');
  ingridientsCont.className = 'title-menu';
  item.items.forEach(function (el, i) {
    var ingredients = document.createElement('p');
    ingredients.className = 'menu-item-lunch';
    ingredients.textContent = "".concat(i + 1, ". ").concat(el, " ");
...
},{"./header":312,"./store":317}],311:[function(require,module,exports){
"use strict";
...
},{"./pagination":313}],312:[function(require,module,exports){
"use strict";
...
exports.incrementHeaderData = incrementHeaderData;
exports.headerLoad = headerLoad;
...
window.onload = function () {
  headerLoad();
  (0, _carousel.carouselOnload)();
};

function showHeader() {
  var products = _store.CART.sort('qty');
...
function incrementHeaderData() {
  ...
  var controls = document.getElementById('header-cart');
  var price = controls.querySelector('a span.header-cart-price');
  var item = controls.querySelector('a span.header-cart-items');
  price.textContent = "".concat(money, " \u0433\u0440\u043D");
  item.textContent = "".concat(itemQty);
}

function headerLoad() {
  _store.CART.init();

  document.getElementById('header').innerHTML = "".concat(showHeader());
  document.getElementById('show-input').addEventListener('click', _search.showInputField);
  document.getElementById('search-form-field').addEventListener('keyup', _search.searching);
}

},{"./carousel":308,"./search":314,"./store.js":317}],313:[function(require,module,exports){
"use strict";
...
exports.showInputField = showInputField;
...
function showInputField(ev) {
  ev.preventDefault();
  var field = document.getElementById('search-form-field');
  var span = document.getElementById('search-form-field').nextElementSibling;
  var subBtn = document.getElementById('submit-link');
  var showBtn = document.getElementById('show-input');
...
function searching(ev) {
  ...
  _displayData.PRODUCTS.forEach(function (item) {
    var title = item.name;
  ...
  document.getElementById('submit-link').addEventListener('click', function () {
    _store.singleItem.add(searchResult);
...
},{"./displayData":309,"./store":317}],315:[function(require,module,exports){
"use strict";
...
/*#__PURE__*/
regeneratorRuntime.mark(function _callee() {
  var data, items, container, paginationContainer, productRoot, product, errorSection;
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          (0, _header.headerLoad)();
          _context.prev = 2;
          _context.next = 5;
          return (0, _displayData.sendAjaxRequest)('GET', './data/db.json');

        case 5:
          data = _context.sent;
          items = JSON.parse(data);

          _displayData.PRODUCTS.push.apply(_displayData.PRODUCTS, _toConsumableArray(items));
          ...
          paginationContainer = document.createElement('div');
          paginationContainer.setAttribute('id', 'pagination');
          productRoot = document.getElementById('single-prod');
          product = JSON.parse(window.localStorage.getItem('singleItems'));

          if (product.length >= 1) {
            product.forEach(function (item) {
              if (item.type !== "business-lunch") {
                var productSection = (0, _displayItems.displayItems)(item);
...
},{"./displayData":309,"./displayItems":310,"./header":312,"./pagination":313,"./store":317}],316:[function(require,module,exports){
"use strict";
...
},{"./pagination":313}],317:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.singleItem = exports.CART = void 0;
...
var CART = {
  ...
  add: function add(id) {
    if (CART.find(id)) {
      ...
      var arr = _displayData.PRODUCTS.filter(function (product) {
        if (product.id === id) {
          return true;
        }
      });
  ...
  sort: function sort() {
    var field = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'title';
...
var singleItem = {
  ...
  content: [],
  init: function init() {
    var _contents = localStorage.getItem(singleItem.key);
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _cart = JSON.stringify(singleItem.content);
              _context3.next = 3;
              return localStorage.setItem(singleItem.key, _cart);
